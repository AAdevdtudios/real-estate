                  ...
                  <div class="pt-6" id="filter-section-0">
                    <div class="space-y-4">
                      <div class="flex items-center">
                        ...
                        <label for="filter-color-0" class="ml-3 text-sm text-gray-600">Lagos</label>
                      </div>
                      ...
                      <div class="flex items-center">
                        ...
                        <label for="filter-color-1" class="ml-3 text-sm text-gray-600">Ibadan</label>
                      </div>
                      ...
                      <div class="flex items-center">
                        ...
                        <label for="filter-color-2" class="ml-3 text-sm text-gray-600">Ikeja</label>
                      </div>
                      ...
                      <div class="flex items-center">
                        ...
                        <label for="filter-color-3" class="ml-3 text-sm text-gray-600">Egbeda</label>
                      </div>
